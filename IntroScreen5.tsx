    ...
    <View style={{ flex: 1 }}>
	  ...
	  <View style={{
		  ...
		  <View style={{
		   ...
		   <Text style={{ fontSize: 18, marginBottom: 40, marginTop: 20, color: '#1E5F4B',  textAlign: 'center', marginHorizontal: 50, fontFamily: 'ArimaMadurai_900Black' }}> RENDS-TOI SUR PLACE </Text>
		   <Text style={{ fontSize: 16, marginBottom: 20, color: 'black',  textAlign: 'center', marginHorizontal: 50, fontFamily: 'Raleway_400Regular' }}> C’est bon, tu es prêt(e) ? Alors rendez-vous au <Text style={{ fontWeight: "bold",}}>16 rue des Fossés</Text> (à Compiègne) ! Allume l’application une fois là-bas...</Text>
          </View>
